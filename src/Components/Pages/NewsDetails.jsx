                    ...
                    <div className="col-span-3">
                        ...
                        <div className="flex flex-col p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
                            <div className="flex space-x-4">
                                <img alt='author image' src={currentNews?.author?.img} className="object-cover w-12 h-12 rounded-full shadow dark:bg-gray-500" />
                            ...
                            <div>
                                <img src={currentNews?.image_url} alt="" className="object-cover w-full mb-4 h-60 sm:h-96 dark:bg-gray-500" />
                                <h2 className="mb-1 text-xl font-semibold">{ currentNews?.title }</h2>
